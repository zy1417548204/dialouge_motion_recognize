...
from ernie_code.preprocess.ernie import task_reader
from ernie_code import ernie
import utils
from NLP_excese.paddle_ex.dialouge_motion_recognize import config
    ...
    if args.do_train:
        ...
        with fluid.program_guard(train_program, startup_prog):
            with fluid.unique_name.guard():
                ...
                optimizer.minimize(train_net["loss"])
